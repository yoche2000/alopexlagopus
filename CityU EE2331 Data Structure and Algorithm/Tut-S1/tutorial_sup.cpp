...
void part_3()
{
	...
	// Try this test after you have debugged your design of longestSubSeq_NoDup().
	/*
	int t = 150000;
	int *x = new int[t];		
	for (int i = 0; i < t; i++)
	...
	// Create a subsequence with no repeating value from first to last (exclusive).
	...
	*/
	...
	// You may watch my YouTube video for an efficient method to find the maximal subsequence.
