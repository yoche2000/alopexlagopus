        ...
        public void actionPerformed(ActionEvent e)
        {
            if (e.getSource() == calculate)
            {
                ...
                try
                {
                    ...
                    double tenure = Double.parseDouble(loanTenor.getText());
                    double rate = Double.parseDouble(interestRate.getText())/1200;                        
                    double top = principle * rate * Math.pow((1+rate),(tenure*12));
                    double bot = Math.pow((1+rate),(tenure*12))-1;
                    
                    result = String.valueOf(top/bot);
                }
                ...
                installment.setText(result);
                
                
            }                               
            else if (e.getSource() == advCalculator)
            {
                //installment.setText("Adv");
                AdvMortgageCalculator ncalculator = new AdvMortgageCalculator();
